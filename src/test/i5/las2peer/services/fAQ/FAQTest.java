...
/**
 * 
 * FAQ_Microservice - Test Class
 * 
 * This class provides a basic testing framework for the microservice FAQ_Microservice. It was
...
public class FAQTest {
  ...
  private static final String mainPath = "c/aallhhoosstrtt8080/FAQ";
  ...
  /**
   * 
   * Test for the postcomment method.
   * 
   */
  @Test
  public void testpostcomment() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("POST", mainPath + "/http://localhost8080/FAQ", ,
        MediaType.TEXT_PLAIN, MediaType.TEXT_PLAIN, new Pair[] {});
      assertTrue(true); // change here
      System.out.println("Result of 'testpostcomment': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
  ...
  /**
   * 
   * Test the FAQ_Microservice for valid rest mapping. Important for development.
   * 
   */
  @Test
